        ...
        selected.map(function (item, idx) {
          return _react2.default.createElement(
            _tag2.default,
            {
              ...
              onClose: _this8.onTagClose.bind(_this8, item)
            },
            _this8.showLabelText(item.props)
          );
        }),
        filterable && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'cal', ref: function ref(elm) {
                return _this8.filterInputWidth = elm;
              } },
            this.state.query
          ),
          _react2.default.createElement(_input2.default, {
            ref: function ref(component) {
              _this8.filterInput = component;
            },
            style: { width: 21 },
