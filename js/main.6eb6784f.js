  ...
  (0, _createClass3.default)(Modal, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props2, ['prefixCls', 'className', 'title', 'footer', 'horizontal', 'styleMask', 'children', 'confirmLoading', 'dragable', 'onCancel', 'cancelText', 'okText', 'width', 'onEntered']);
      var _state = this.state,
