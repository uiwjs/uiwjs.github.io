...
/*#__PURE__*/
function (_Markdown) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(Input, _Markdown);

  function Input() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Input);

    return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_1___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_2___default()(Input).apply(this, arguments));
  }
...
(function () {
  ...
  reactHotLoader.register(Input, "Input", "/Users/kenny/git/github/@uiw/uiw/docs/pages/input/index.js");
  leaveModule(module);
})();
