...
var _strings = __webpack_require__(64);
    ...
    value: function render() {
      ...
      var childStyle = function childStyle(child) {
        return (0, _assign2.default)({}, child && child.props ? child.props.style : {}, other.style, {
          transitionDuration: (_this2.animation ? duration : 0) + 'ms'
        });
      };
      var childClassName = function childClassName(child, transitionStatus) {
        var clss = _this2.classNames((0, _defineProperty3.default)({}, '' + prefixCls, prefixCls && _this2.animation), className, sequenceClassNames, transitionStatus && animationStyles[transitionStatus], child && child.props && child.props.className);
        return clss;
      };
        ...
        function (status) {
          return _react2.default.cloneElement(children, {
            ...
            ref: function ref(elm) {
              _this2.dom = elm;
              _this2.refsSizeChange(elm, status);
            }
          });
        }
      );
...
var _paging = __webpack_require__(90);
  ...
  (0, _createClass3.default)(Loading, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'className', 'size', 'children', 'tip', 'type', 'loading']);

      var iconContent = _react2.default.createElement('div', { className: prefixCls + '-icon' });
      if (type === 'donut') iconContent = _react2.default.createElement('div', { className: prefixCls + '-icon-donut' });
...
Loading.propTypes = {
  ...
  type: _utils.PropTypes.oneOf(['doubleBounce', 'donut'])
};
...
var Modal = function (_Component) {
  ...
  (0, _createClass3.default)(Modal, [{
    ...
    key: 'onMouseDown',
    value: function onMouseDown(type, event) {
      var _props2 = this.props,
          dragable = _props2.dragable,
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          styleMask = _props3.styleMask,
          children = _props3.children,
          confirmLoading = _props3.confirmLoading,
          dragable = _props3.dragable,
          resizeable = _props3.resizeable,
          onCancel = _props3.onCancel,
          cancelText = _props3.cancelText,
          okText = _props3.okText,
          width = _props3.width,
          onEntered = _props3.onEntered,
          other = (0, _objectWithoutProperties3.default)(_props3, ['prefixCls', 'className', 'title', 'footer', 'horizontal', 'styleMask', 'children', 'confirmLoading', 'dragable', 'resizeable', 'onCancel', 'cancelText', 'okText', 'width', 'onEntered']);
      var _state = this.state,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            title && _react2.default.createElement(
              'div',
              {
                className: this.classNames(prefixCls + '-header', (0, _defineProperty3.default)({}, prefixCls + '-dragable', dragable)),
            ...
            _react2.default.createElement(
              'div',
              { className: prefixCls + '-body', ref: function ref(node) {
                  return _this3.bodyDom = node;
                } },
              children
            ),
            defaultFooter,
            resizeable && _react2.default.createElement('div', { className: prefixCls + '-resizeable', onMouseDown: this.onMouseDown.bind(this, 'size') })
          )
        )
      );
    }
...
Modal.propTypes = {
  ...
  dragable: _utils.PropTypes.bool,
...
var Canvas = function (_React$Component) {
  ...
  (0, _createClass3.default)(Canvas, [{
    ...
    value: function renderSource(value) {
      ...
      Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 65, 7)).then(function (Element) {
...
var _locales = __webpack_require__(85);
  ...
  (0, _createClass3.default)(FormItem, [{
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          resetProps = (0, _objectWithoutProperties3.default)(_props3, ['prefixCls', 'className', 'label', 'field', 'labelCol', 'wrapperCol']);
  ...
  (0, _createClass3.default)(InputPassword, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'onIconClick']);
...
var _utils2 = __webpack_require__(88);
    ...
    value: function selectedData(init) {
      ...
      if (multiple && Array.isArray(value)) {
        ...
        this.setState((0, _extends3.default)({}, state), function () {
          (filterable || multiple) && _this3.resetInputHeight(init);
        });
      } else {
...
var _TimePickerSpinner = __webpack_require__(89);
  ...
  (0, _createClass3.default)(Input, [{
    ...
    value: function renderIcon(type) {
      ...
      var _props2 = this.props,
          ...
          onPreIconClick = _props2.onPreIconClick,
          onIconMouseOut = _props2.onIconMouseOut,
          onPreIconMouseOut = _props2.onPreIconMouseOut,
          onIconMouseOver = _props2.onIconMouseOver,
          onPreIconMouseOver = _props2.onPreIconMouseOver;
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props3, ['prefixCls', 'className', 'style', 'type', 'size', 'length', 'preIcon', 'icon', 'value', 'onSearch', 'onIconClick', 'onPreIconClick', 'onIconMouseOut', 'onPreIconMouseOut', 'onIconMouseOver', 'onPreIconMouseOver', 'addonBefore', 'addonAfter']);
...
var Tabs = function (_Component) {
  ...
  (0, _createClass3.default)(Tabs, [{
    ...
    value: function onTabREmove(item, idx, e) {
      ...
      this.setState((0, _extends3.default)({}, state), function () {
        _this5.calcSlideStyle(idx);
        onTabRemove(item, idx, e);
      });
    }
  }, {
    key: 'onTabAdd',
    value: function onTabAdd(e) {
      var _props = this.props,
      ...
      if (children.length > 0) {
        lastChild = children.filter(function (item, idx) {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          tabBarExtra = _props2.tabBarExtra,
          onTabClick = _props2.onTabClick,
          onTabAdd = _props2.onTabAdd,
          onTabRemove = _props2.onTabRemove,
          closable = _props2.closable,
          other = (0, _objectWithoutProperties3.default)(_props2, ['prefixCls', 'className', 'position', 'type', 'sequence', 'tabBarExtra', 'onTabClick', 'onTabAdd', 'onTabRemove', 'closable']);
      var _state2 = this.state,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: prefixCls + '-nav-extra' },
            tabBarExtra,
            onTabAdd && _react2.default.createElement(_icon2.default, { onClick: this.onTabAdd.bind(this), className: prefixCls + '-new-tab', type: 'plus' })
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.Children.map(children, function (item, idx) {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  {
                    className: _this7.classNames(prefixCls + '-tab', {
                      'w-disabled': disabled,
                      'w-active': item.key === activeKey,
                      'w-closable': closable
                    }),
                    onClick: _this7.onTabClick.bind(_this7, item, item.key)
                  },
                  label,
                  item.props.closable !== false && closable && _react2.default.createElement(_icon2.default, { type: 'close', onClick: _this7.onTabREmove.bind(_this7, item, idx) })
                )
              );
            }),
            Line
        ...
        _react2.default.createElement(
          ...
          _react2.default.Children.map(children, function (item) {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: _this7.classNames(prefixCls + '-pane', { 'w-disabled': props.disabled }) },
                props.children
              )
            );
          })
...
Tabs.propTypes = {
  prefixCls: _utils.PropTypes.string,
  sequence: _utils.PropTypes.string,
  tabBarExtra: _utils.PropTypes.node,
  ...
  onTabAdd: _utils.PropTypes.func, // tab 添加按钮的回调
  disabled: _utils.PropTypes.bool,
          ...
          this.isColumnsFixed(columns, 'left') && _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                showHeader && _react2.default.cloneElement(tableThead(), {
                  cloneElement: 'left'
                })
              )
            ),
            ...
            data.length === 0 ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'td',
                  { ref: function ref(elm) {
                      if (elm && _this2.tableThead && showHeader) {
...
Table.propTypes = {
  columns: _utils.PropTypes.array,
  prefixCls: _utils.PropTypes.string,
  showHeader: _utils.PropTypes.bool,
...
var _MixinComponent2 = __webpack_require__(62);
  ...
  (0, _createClass3.default)(MenuItemGroup, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          title = _props.title,
          children = _props.children,
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'style', 'className', 'title', 'children']);
      var _menu$props = this.menu().props,
          inlineIndent = _menu$props.inlineIndent,
          mode = _menu$props.mode;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: prefixCls + '-title', style: (0, _extends3.default)({}, style, styles) },
          title
        ),
        _react2.default.createElement(
          'ul',
  ...
  (0, _createClass3.default)(SubMenu, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          className = _props.className,
          title = _props.title,
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'style', 'index', 'className', 'title']);
      var _menu$props = this.menu().props,
          inlineIndent = _menu$props.inlineIndent,
          mode = _menu$props.mode;
      ...
      return _react2.default.createElement(
        ...
        (0, _extends3.default)({
          ...
          style: (0, _extends3.default)({}, style, styles)
        }),
        _react2.default.createElement(
          'div',
          { ref: function ref(elm) {
  ...
  (0, _createClass3.default)(MenuItem, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style,
          index = _props.index,
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'className', 'style', 'index']);
      var _menu$props = this.menu().props,
          inlineCollapsed = _menu$props.inlineCollapsed,
          inlineIndent = _menu$props.inlineIndent,
          mode = _menu$props.mode;
...
function _getLevelNumber(items, key) {
  ...
  items.forEach(function (item) {
    if (item.props.children && Array.isArray(item.props.children)) {
      var childs = item.props.children.filter(function (_item) {
        return _item.props && _item.props.index;
      });
      if (childs && childs.length > 0) {
        var indexChild = _getLevelNumber(childs, key, index + 1);
...
var Menu = function (_Component) {
  ...
  (0, _createClass3.default)(Menu, [{
    ...
    key: 'getLevelNumber',
    value: function getLevelNumber(key) {
      var idx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;

      return _getLevelNumber(this.props.children, key, idx);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var _props = this.props,
          ...
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'inlineIndent', 'className', 'style', 'mode', 'theme', 'defaultActive', 'inlineCollapsed', 'onSelect', 'onOpen', 'defaultOpened']);

      return _react2.default.createElement(
        'ul',
        (0, _extends3.default)({
          style: style,
          className: this.classNames(className, '' + prefixCls, (_classNames = {}, (0, _defineProperty3.default)(_classNames, prefixCls + '-' + mode, mode), (0, _defineProperty3.default)(_classNames, prefixCls + '-' + theme, theme), (0, _defineProperty3.default)(_classNames, prefixCls + '-inline-collapsed', inlineCollapsed && mode === 'vertical'), _classNames))
        }, resetProps),
        this.props.children
      );
    }
...
Menu.propTypes = {
  ...
  inlineIndent: _utils.PropTypes.number,
  onSelect: _utils.PropTypes.func
};
  ...
  (0, _createClass3.default)(Card, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          children = _props.children,
          resetProps = (0, _objectWithoutProperties3.default)(_props, ['prefixCls', 'className', 'title', 'extra', 'footer', 'bordered', 'noHover', 'bodyStyle', 'bodyClassName', 'children']);
      ...
      return _react2.default.createElement(
        ...
        children && _react2.default.createElement(
          'div',
          { className: this.classNames(prefixCls + '-body', bodyClassName), style: bodyStyle },
          children
        ),
        footer && _react2.default.createElement(
          'div',
...
Card.propTypes = {
  ...
  bodyClassName: _utils.PropTypes.string
};
...
Alert.propTypes = {
  ...
  closable: _utils.PropTypes.bool,
  description: _utils.PropTypes.oneOfType([_utils.PropTypes.node, _utils.PropTypes.string]),
  onClose: _utils.PropTypes.func
};
Alert.defaultProps = {
  type: 'default',
